...
def run():
    ...
    auth.configure_curve( domain='*', location=zmq.auth.CURVE_ALLOW_ANY ) # public_keys_dir )   #  Use 'location=zmq.auth.CURVE_ALLOW_ANY' for stonehouse, 'location=public_keys_dir' for Ironhouse
